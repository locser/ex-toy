...
- **JSON trong `events.rules`:** Linh hoạt nhưng khó truy vấn trực tiếp vào các quy tắc cụ thể bằng SQL chuẩn. Cần xử lý ở tầng ứng dụng hoặc sử dụng các hàm JSON của MySQL nếu cần.
