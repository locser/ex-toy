...
// Temporarily commented out Swagger imports
...
public class OpenApiConfig {
        ...
        // Temporarily commented out Swagger configuration
        /*
         * @Bean
         ...
         * new
         * Server().url("https://api.toyexchange.com").description("Production server"))
         * )
