...
public class EventController {
        ...
        public BaseResponse<PageResponseDTO<EventResponseDTO>> getEventsWithPagination(
                ...
                var pageResponse = eventService.getEventsWithPagination(page, limit, status, sortBy, sortDirection);
        ...
        public BaseResponse<EventResponseDTO> getEventById(@ValidId(entity = "Event") @PathVariable Long id) {
