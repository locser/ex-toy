...
public class ToyServiceImpl implements ToyService {
    ...
    public ToyServiceImpl(ToyApplicationService toyApplicationService, ToyDomainService toyDomainService) {
    ...
    public ToyResponseDTO createToy(Long userId, CreateToyRequestDTO request) {
        ToyDTO toyDTO = toyApplicationService.createToy(userId, ToyDTOMapper.toCreateToyRequest(request));
    ...
    @Override
    public PageResponseDTO<ToyResponseDTO> getToysWithPagination(int page, int limit, Long userId, Integer status,
            Long campaignId, String sortBy, String sortDir) {
        PageResponse<ToyDTO> pageResponse = toyApplicationService.getToysWithPagination(page, limit, userId, status,
