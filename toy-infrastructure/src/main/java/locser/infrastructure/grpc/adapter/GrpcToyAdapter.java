 ...
 * This follows the Adapter pattern to isolate the domain model from the gRPC
 * implementation.
 */
@Component
@Slf4j
public class GrpcToyAdapter {
     ...
     * @return The gRPC CreateToyRequest.Builder
     */
    public CreateToyRequest.Builder toGrpcCreateRequestBuilder(
            locser.toy.domain.model.dto.CreateToyRequest domainRequest) {
     ...
     * @return The gRPC UpdateToyRequest.Builder
     */
    public UpdateToyRequest.Builder toGrpcUpdateRequestBuilder(
            locser.toy.domain.model.dto.UpdateToyRequest domainRequest, Long toyId) {
        if (domainRequest == null) {
            return null;
        }
